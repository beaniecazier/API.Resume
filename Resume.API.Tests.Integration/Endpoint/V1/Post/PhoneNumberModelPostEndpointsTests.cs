...
public class PhoneNumberModelPostEndpointsTests : IClassFixture<IntegrationTestWebApplicationFactory>, IAsyncLifetime
{
    private readonly IntegrationTestWebApplicationFactory _factory;

    private List<int> _createdPhoneNumberModels = new List<int>();

    public PhoneNumberModelPostEndpointsTests(IntegrationTestWebApplicationFactory factory)
    {
        _factory = factory;
    }
    ...
    public async Task CreatePhoneNumberModel_CreatesPhoneNumberModel_WhenDataIsCorrect()
    {
        ...
        // ACT
        var result = await httpClient.PostAsJsonAsync(PhoneNumberModelEndpoints.Post, modelRequest);
        ...
        result.Headers.Location.AbsolutePath.Should().Be($"/{PhoneNumberModelEndpoints.EndpointPrefix}/{createdModel.Id}");
    }
