...
public class PhoneNumberModelGetEndpointsTests : IClassFixture<IntegrationTestWebApplicationFactory>, IAsyncLifetime
{
    private readonly IntegrationTestWebApplicationFactory _factory;

    private List<int> _createdPhoneNumberModels = new List<int>();

    public PhoneNumberModelGetEndpointsTests(IntegrationTestWebApplicationFactory factory)
    {
        _factory = factory;
    }
    ...
    public async Task GetPhoneNumberModel_ReturnsPhoneNumberModel_WhenModelExists()
    {
        ...
        // ACT
        var result = await httpClient.GetAsync($"{PhoneNumberModelEndpoints.EndpointPrefix}/{createdModel.Id}");
    ...
    public async Task GetPhoneNumberModel_ReturnsNotFound_WhenModelDoesNotExist()
    {
        ...
        // ACT
        var result = await httpClient.GetAsync($"{PhoneNumberModelEndpoints.EndpointPrefix}/{-1000000}");
    ...
    public async Task GetAllPhoneNumberModels_ReturnsAllModelsUnsorted_WhenModelsExist()
    {
        ...
        var result = await httpClient.GetAsync($"{PhoneNumberModelEndpoints.EndpointPrefix}?{searchTerms}");
