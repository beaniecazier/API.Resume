...
public class PhoneNumberModelDeleteEndpointsTest : IClassFixture<IntegrationTestWebApplicationFactory>, IAsyncLifetime
{
    private readonly IntegrationTestWebApplicationFactory _factory;

    private List<PhoneNumberModelResponse> _createdPhoneNumberModels = new List<PhoneNumberModelResponse>();

    public PhoneNumberModelDeleteEndpointsTest(IntegrationTestWebApplicationFactory factory)
    {
        _factory = factory;
    }
    ...
    public async Task DeletePhoneNumberModel_ReturnsOk_WhenModelDoesExist()
    {
        ...
        // ACT
        var result = await httpClient.DeleteAsync($"{PhoneNumberModelEndpoints.EndpointPrefix}/{createdResponse.Id}");
    ...
    public async Task DeletePhoneNumberModel_ReturnsNotFound_WhenModelDoesNotExist()
    {
        ...
        // ACT
        var result = await httpClient.DeleteAsync($"{PhoneNumberModelEndpoints.EndpointPrefix}/{-1000000}");
