...
public class WorkExperienceModelDeleteEndpointsTest : IClassFixture<IntegrationTestWebApplicationFactory>, IAsyncLifetime
{
    private readonly IntegrationTestWebApplicationFactory _factory;

    private List<WorkExperienceModelResponse> _createdWorkExperienceModels = new List<WorkExperienceModelResponse>();

    public WorkExperienceModelDeleteEndpointsTest(IntegrationTestWebApplicationFactory factory)
    {
        _factory = factory;
    }
