...
public static class GetAllPagedRequestExtensions
{
    ...
    public static string ToSearchTermsString(this GetAllContactModelsRequest request)
    {
        List<string> results = new List<string>();
        if (request.AllowDeleted.HasValue) results.Add($"AllowDeleted={request.AllowDeleted.Value}");
        if (request.AllowHidden.HasValue) results.Add($"AllowHidden={request.AllowHidden.Value}");
    ...
    public static string ToSearchTermsString(this GetAllCountryCodeModelsRequest request)
    {
        List<string> results = new List<string>();
        if (request.AllowDeleted.HasValue) results.Add($"AllowDeleted={request.AllowDeleted.Value}");
        if (request.AllowHidden.HasValue) results.Add($"AllowHidden={request.AllowHidden.Value}");
    ...
    public static string ToSearchTermsString(this GetAllOrganizationModelsRequest request)
    {
        List<string> results = new List<string>();
        if (request.AllowDeleted.HasValue) results.Add($"AllowDeleted={request.AllowDeleted.Value}");
        if (request.AllowHidden.HasValue) results.Add($"AllowHidden={request.AllowHidden.Value}");
