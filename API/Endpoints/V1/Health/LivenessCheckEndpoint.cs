...
public class LivenessCheckEndpoint : IEndpoints, IHealthCheck
{
    ...
    /// <summary>
    /// Liveness Check Endpoint Constructor
    /// </summary>
    /// <param name="options">CLI options, looking for Liveness Check port</param>
    public LivenessCheckEndpoint(CMDOptions options)
    {
        _port = options.LivenessCheckPort;
