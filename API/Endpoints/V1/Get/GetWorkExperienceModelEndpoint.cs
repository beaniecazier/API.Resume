...
public class GetWorkExperienceModelEndpoint : IEndpoints
{
    ...
    {
        // Read Endpoints
        var singleEndpoint = app.MapGet(WorkExperienceModelEndpoints.GetById, GetWorkExperienceModelByIDAsync)
            ...
            .HasApiVersion(1.0)
            .CacheOutput(WorkExperienceModelEndpoints.Tag)
            .WithTags(WorkExperienceModelEndpoints.Tag);

        var multipleEndpoint = app.MapGet(WorkExperienceModelEndpoints.GetAll, GetAllWorkExperienceModelsAsync)
