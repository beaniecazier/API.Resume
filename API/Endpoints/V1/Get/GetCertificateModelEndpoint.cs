...
public class GetCertificateModelEndpoint : IEndpoints
{
    ...
    private static async Task<IResult> GetCertificateModelByIDAsync(int id, ICertificateModelService service, CancellationToken token)
    {
        ...
        return entry.Match(
            ...
            Fail =>
            {
                ...
                Log.Error(ex, $"Server issue encountered while trying to get Certificate Model with ID:{id} from the database");
