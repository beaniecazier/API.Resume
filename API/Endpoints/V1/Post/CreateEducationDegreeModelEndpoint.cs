...
public class CreateEducationDegreeModelEndpoint : IEndpoints
{
    ...
    public static void DefineEndpoints(IEndpointRouteBuilder app)
    {
        ...
        var singleEndpoint = app.MapPost(EducationDegreeModelEndpoints.Post, CreateEducationDegreeModelAsync)
        ...
        IOutputCacheStore outputCacheStore, LinkGenerator linker, HttpContext http, CancellationToken token)
    {
        ...
        var requestedOrganizationModel = await organizationService.GetByIDAsync(request.Institution, token);
        ...
        if(!created.IsFail) await outputCacheStore.EvictByTagAsync(EducationDegreeModelEndpoints.Tag, token);
