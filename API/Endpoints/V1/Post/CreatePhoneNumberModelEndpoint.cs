...
public class CreatePhoneNumberModelEndpoint : IEndpoints
{
    ...
    public static void DefineEndpoints(IEndpointRouteBuilder app)
    {
        ...
        var singleEndpoint = app.MapPost(PhoneNumberModelEndpoints.Post, CreatePhoneNumberModelAsync)
        ...
        IOutputCacheStore outputCacheStore, LinkGenerator linker, HttpContext http, CancellationToken token)
    {
        ...
        var requestedCountryCodeModel = await countryCodeService.GetByIDAsync(request.CountryCode, token);
        ...
        var model = request.MapToModelFromCreateRequest(id, username, (CountryCodeModel)requestedCountryCodeModel!);
        ...
        if(!created.IsFail) await outputCacheStore.EvictByTagAsync(PhoneNumberModelEndpoints.Tag, token);
