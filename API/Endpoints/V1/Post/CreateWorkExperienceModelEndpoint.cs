...
public class CreateWorkExperienceModelEndpoint : IEndpoints
{
        ...
        IOutputCacheStore outputCacheStore, LinkGenerator linker, HttpContext http, CancellationToken token)
    {
        ...
        var requestedOrganizationModel = await organizationService.GetByIDAsync(request.Company, token);
        ...
        var model = request.MapToModelFromCreateRequest(id, username, (OrganizationModel)requestedOrganizationModel!, (List<TechTagModel>)requestedTechTagModels);
