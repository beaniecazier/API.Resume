...
public static class WorkExperienceModelContractMapping
{
    public static WorkExperienceModel MapToModelFromCreateRequest(this CreateWorkExperienceModelRequest request,
        int id, string username, OrganizationModel company, List<TechTagModel> techUsedes)
    {
    ...
    public static WorkExperienceModel MapToModelFromUpdateRequest(this UpdateWorkExperienceModelRequest request, string username, OrganizationModel company, List<TechTagModel> techUsedes)
    {
    ...
    public static WorkExperienceModelResponse MapToResponseFromModel(this WorkExperienceModel model)
    {
        return new WorkExperienceModelResponse
        {
			...
			Company = model.Company.MapToResponseFromModel(),
			Description = model.Description,
			Responsibilities = model.Responsibilities,
			TechUsed = model.TechUsed.Select(m => m.MapToResponseFromModel()).ToList(),
			EmploymentType = model.EmploymentType.ToString(),
        };
    }
}
